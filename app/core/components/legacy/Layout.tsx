...
const Layout = ({
  ...
  <>
    <Head>
      ...
      <meta name='title' content={title ?? 'Progressive App Store'} key='title' />
      ...
      {/* <meta
        ...
        key="twitter-image"
      /> */}
      <meta property='twitter:site' content='Historic Borders' key='twitter-site' />
      <meta property='twitter:image:height' content='1200' key='twitter-height' />
